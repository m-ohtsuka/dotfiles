...
(doom! :input
       ...
       (:if (not (featurep :system 'windows)) ghostel +everywhere) ; the best terminal emulation in Emacs
       ...
       (org +dragndrop +journal +pandoc +roam +pretty +gnuplot) ; organize your plain life in plain text
